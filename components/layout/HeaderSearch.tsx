    ...
    <>
      <div className="relative hidden md:block">
        ...
        <button
          ...
          className="w-64 pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-left text-sm text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer hover:bg-slate-100 transition-all"
        >
          검색... (Ctrl+K)
        </button>
      </div>
