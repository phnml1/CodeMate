...
export const MOCK_PRS: PullRequest[] = [
  {
    ...
    mergedAt: null,
    closedAt: null,
    githubCreatedAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    githubUpdatedAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    closedAt: null,
    githubCreatedAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
    githubUpdatedAt: new Date(Date.now() - 24 * 60 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    githubCreatedAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    githubUpdatedAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    closedAt: null,
    githubCreatedAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    githubUpdatedAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    createdAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
